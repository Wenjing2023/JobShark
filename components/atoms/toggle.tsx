  ...
  return (
    <>
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        />
        <div
          className={`w-11 h-6 bg-jaws-light-blue peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-jaws-light-blue dark:peer-focus:ring-blue-300 rounded-full 
          ${
            isChecked
          ...
          ${isChecked ? "peer-checked:bg-jaws-blue" : ""}`}
        ></div>
